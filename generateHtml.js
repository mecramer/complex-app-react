...
import ReactDOMServer from 'react-dom/server' // this allows us to use React to generate html outside the context of a browser
import fs from 'fs'
...
// to generate an html skeleton used while components are loading
function Shell () {
    return (
